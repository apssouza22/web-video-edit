...
- [x] Analyze dependencies and types from constants.js and media modules
...
- [x] Convert media-audio.js to audio.ts extending typed StandardLayer
...
5. `src/audio/media-audio.js` → `src/audio/audio.ts`
