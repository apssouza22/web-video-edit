...
- [x] Create types for layer bounds and coordinate systems
- [x] Define interfaces for transformation states and drag operations

### Phase 2: PlayerLayer Class Conversion
- [x] Convert `src/player/player-layer.js` to `src/player/player-layer.ts`
...
### Phase 3: VideoPlayer Class Conversion
- [x] Convert `src/player/player.js` to `src/player/player.ts`
- [x] Add proper typing for Canvas/AudioContext APIs
- [x] Type layer array and layer management methods
...
- [x] Type the createPlayer factory function
